...
DROP VIEW IF EXISTS BI_Distribución_Facturación
DROP VIEW IF EXISTS BI_Ranking_Solicitudes_Por_Temporadas
DROP VIEW IF EXISTS BI_Anticipación_Promedio_Solicitudes
DROP VIEW IF EXISTS BI_Tasa_Aceptación_Propuestas
DROP VIEW IF EXISTS BI_Cotización_Promedio_Por_Temporada
DROP VIEW IF EXISTS BI_Tiempo_Promedio_Respuesta
DROP VIEW IF EXISTS BI_Desvío_Presupuesto_Promedio
DROP VIEW IF EXISTS BI_Ranking_Aspectos_Valorados
DROP VIEW IF EXISTS BI_Satisfacción_Promedio_Por_Agente
GO
