...
BEGIN
	BEGIN TRY
		INSERT INTO PLATENSE.Venta (nro_venta, nro_cliente, nro_agente, nro_canal_venta, nro_medio_pago,nro_propuesta ,fecha, subtotal, descuento, importe_total)
			SELECT DISTINCT M.Venta_Nro_Venta, C.nro_cliente, M.Agente_Legajo, CV.nro_canal, MP.nro_medio, M.Propuesta_Nro_Propuesta, 
